...
<h2><?php  __('Affiliate');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Parent Affiliate'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Referral Key'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
<div class="related">
	<h3><?php __('Related Affiliates');?></h3>
